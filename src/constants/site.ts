export const siteConfig = {
  ...
  heroSubtitle:
    'Soft POS designs and develops custom software, POS platforms, ordering systems and connected experiences that help your business grow.',
} as const
